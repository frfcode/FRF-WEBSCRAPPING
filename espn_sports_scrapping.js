...
function init() {
  ...
  for (let index = 0; index < teams.length; index++) {
    ...
    urlIndeed = `https://www.espn.com/${getDataTeam.category}/team/_/name/${
      getDataTeam.geoLocation
    }/${getDataTeam.team.replaceAll(" ", "-")}`;
    //CALL FUNCTION
    let getEspnArrayData = getDataUrlIndeed(urlIndeed).then((content) => {
      ...
      let getArticles =
        convertToJSON.page.content.clubhouse.columns.middleColumn.clubhouse
          .feed;
